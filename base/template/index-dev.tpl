...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{template_path}/style-dev.css">
    <!-- 
    ...
    <div class="container header">
      ...
      <div class="center">
        <div class="container">
          ...
          <div class="logo">
            <img class="logo" src="{template_path}/sheep.svg" alt="logo">
          </div>
          <div class="title">
            <div class="name">BlaatSchaap</div>
            <div class="slogan">Developers Playground</div>
          </div>
          <div class="spacer"></div>
        </div>
      </div>
